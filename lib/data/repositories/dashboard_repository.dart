  ...
  List<DashboardItem> _generateMockItems() {
    ...
    return [
      DashboardItem(
        ...
        description: 'Compile and review quarterly revenue figures across all departments.',
      ...
      DashboardItem(
        ...
        description: 'Update onboarding documentation and training materials for new hires.',
      ...
      DashboardItem(
        ...
        description: 'Plan and execute migration from legacy servers to cloud infrastructure.',
        status: ItemStatus.active,
      ...
      DashboardItem(
        ...
        description: 'Draft and finalize the service proposal for Acme Corporation.',
      ...
      DashboardItem(
        ...
        description: 'Review findings from the annual security audit and create action items.',
        status: ItemStatus.active,
        priority: ItemPriority.high,
        category: 'Operations',
      ...
      DashboardItem(
        ...
        description: 'Coordinate the launch of the spring marketing campaign across all channels.',
        status: ItemStatus.pending,
        priority: ItemPriority.medium,
        category: 'Marketing',
      ...
      DashboardItem(
        ...
        description: 'Process the approved budget changes for the operations department.',
      ...
      DashboardItem(
        ...
        description: 'Negotiate and renew annual contracts with key technology vendors.',
        status: ItemStatus.active,
        priority: ItemPriority.medium,
        category: 'Operations',
        assignedTo: 'Jane Doe',
